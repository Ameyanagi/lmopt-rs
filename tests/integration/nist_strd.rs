...
fn test_misra1a_model() {
    let (model, certified_params, certified_std_devs) = load_misra1a().unwrap();
        ...
        LevenbergMarquardtResult::Success(solution) => {
            ...
            for i in 0..certified_params.len() {
                ...
                assert!(rel_error < 0.01, 
                    ...
                    i, optimized_params[i], certified_params[i]);
            }
            ...
            assert!(rel_error < 0.01, 
                ...
                residual_norm, expected_residual_norm);
...
fn load_thurber() -> Result<(NISTModel, Array1<f64>, Array1<f64>), Box<dyn Error>> {
    ...
    let x_data = vec![
        ...
        -0.109, -0.103, 0.010, 0.119, 0.377, 0.790, 0.963, 1.006, 1.115,
        1.572, 1.841, 2.047, 2.200
    ];
    ...
    let y_data = vec![
        ...
        1260.531, 1273.514, 1288.339, 1327.543, 1353.863, 1414.509, 1425.208, 1421.384, 1442.962,
    ...
    let certified_std_devs = Array1::from_vec(vec![
        4.6647963344E+00, 3.9571156086E+01, 2.8698696102E+01, 5.5675370270E+00,
...
fn test_thurber_model() {
    let (model, certified_params, certified_std_devs) = load_thurber().unwrap();
