//! Standalone test for uncertainty propagation
//!
//! This file tests the uncertainty propagation functionality without
//! requiring other parts of the codebase to be fixed first.
